...
import com.mob.user.watched.database.interactors.mapper.DeviceDomainToEntityMapper
...
internal constructor(
    ...
    private val moviesMoviesDomainToEntityMapper: DeviceDomainToEntityMapper
) : MoviesInteractor {
    ...
    override fun setMovie(moviesDomain: MoviesDomain) {
        return moviesDAO.insertMovie(moviesMoviesDomainToEntityMapper.map(moviesDomain))
    }
}
